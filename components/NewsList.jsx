    ...
    <>
      ...
      <AnimatePresence>
        {selectedNews && (
          ...
          >
            <div className="relative w-full max-w-3xl max-h-[95vh] bg-white dark:bg-[#1a1a1a] rounded-2xl shadow-2xl flex flex-col overflow-hidden">
              <button
                onClick={() => setSelectedNews(null)}
                className="absolute top-3 right-3 z-10 text-white bg-red-600 hover:bg-red-700 w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-xl shadow transition"
                aria-label="Close"
              >
                &times;
              </button>
